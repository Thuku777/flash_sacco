...
from . import views
from . views import UserPage, Member,History, Loans, Update, Register, buySharesHandler, loansHandler, pinUpdate
...
urlpatterns = [
    ...
    path('loans/', views.loansHandler, name='loans' ),
    ...
    path('<int:slug>/', views.pinUpdate, name='pinUpdate')
]
