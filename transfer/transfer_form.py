...
class SharesForm(forms.Form):
   senderAccNo=forms.IntegerField(widget=forms.TextInput(attrs={'class':'form-control', 'required':True, 'autocomplete':'off','placeholder':'Account Number' }), label='My Account Number')
   recpAccNo=forms.IntegerField(widget=forms.TextInput(attrs={'class':'form-control', 'required':True, 'autocomplete':'off','placeholder':'Account Number' }), label='Recepient Account Number')
   amount=forms.IntegerField(widget=forms.TextInput(attrs={'class':'form-control unknown', 'required':True, 'autocomplete':'off','placeholder':'Number of Shares' }), label='Shares')
